...
[guildctl] environment: 2 divergence(s) between .env and the inherited environment
  ANTHROPIC_BASE_URL  .env=https://rootsys.cloud/v1  ambient=https://api.openai.com/v1  → .env wins
  ROOTSYS_API_KEY     .env=<redacted>                ambient=<redacted>                 → .env wins
```

```json
{ "mode": "project",
  "divergences": [
    { "variable": "ANTHROPIC_BASE_URL", "project_value": "https://rootsys.cloud/v1",
      "ambient_value": "https://api.openai.com/v1", "winner": "project-file", "secret": false },
    { "variable": "ROOTSYS_API_KEY", "project_value": "<redacted>",
