...
✗ preflight FAILED
  ...
  provider:  https://rootsys.cloud/v1
  model:     fiq/hy3-tencent
  credential: ROOTSYS_API_KEY (set, rejected by provider)
...
```json
{
  ...
  "resolved": { "harness": "opencode", "harness_command": "package/harness/opencode.mjs",
                "provider": "https://rootsys.cloud/v1", "model": "fiq/hy3-tencent",
                "credential_env": "ROOTSYS_API_KEY" },
  "divergences": [ { "setting": "model.model", "declared": "fiq/hy3-tencent", "resolved": "fiq/grok-4.5" } ],
