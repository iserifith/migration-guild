...
- **Polish (Phase 8)**: Depends on all five user story phases being complete (T004, T008, T020, T024, T034).
...
7. Complete Polish (T035–T037) → full-suite confirmation (SC-001–SC-005 simultaneously) and a top-level `build:dist` + doc-grep sanity pass outside the test suite.
