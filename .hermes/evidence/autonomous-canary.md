...
Workspace: `/home/example-corp/projects/migration-canary-targets/live-private-relay-canary-20260715`
...
- The CLI was invoked with top-level `--db /home/example-corp/.hermes/tmp/migration-guild-live-canary/registry-db-handoff.db` while `REGISTRY_DB` was explicitly unset and `.guild/config.yaml` pointed at the deliberately wrong workspace-local `.guild/wrong-registry.db`.
