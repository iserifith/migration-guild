...
const BlockersTab = React.memo(({ blockers, issues, blockerQuery, updateBlockerQuery, issueQuery, updateIssueQuery, timeMode }: Pick<TabProps, 'blockers' | 'issues' | 'blockerQuery' | 'updateBlockerQuery' | 'issueQuery' | 'updateIssueQuery' | 'timeMode'>) => (
  <BlockersView
...
const TABS: TabDef[] = [
  ...
  },
  {
    id: "Blockers",
    label: "Blockers",
    render: ({ blockers, issues, blockerQuery, updateBlockerQuery, issueQuery, updateIssueQuery, timeMode }) => (
      <BlockersTab
        blockers={blockers}
        issues={issues}
        blockerQuery={blockerQuery}
