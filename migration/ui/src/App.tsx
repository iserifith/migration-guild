...
// ⚡ Bolt: also memoize parameterised tab views so inline arrow functions in
// TABS do not create referentially new tree roots that unmount/re-render child
// lists (ArtifactList, SessionsView) on every global useRegistryData tick.
